            ...
            foreach ($mes_ventes as $not) {
	              ...
	              <div class="media text-muted pt-3">
			        ...
			        <div class="pull-right">
	                    ...
	                    <a onclick="return confirm('Etes-vous sûre de vouloire Supprimer ce cours dans la liste favorie?')" href="<?php echo(base_url()) ?>user/view_1/display_delete_vente/<?php echo($not['code']) ?>" class="btn btn-default btn-sm"><i class="fa fa-trash"></i> supprimer</a> 
		           </div>
			    </div>
