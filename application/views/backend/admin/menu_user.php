    			...
    			<div class="col-md-6">
    				<div class="card-inner p-0">
					    <ul class="list-group">
					    	  ...
					    	  <li class=""><a href="<?php echo(base_url()) ?>admin/profile"> <i class="fa fa-user"></i>&nbsp; Profile</a></li>
							  <li class=""><a href="<?php echo(base_url()) ?>admin/basic"><i class="fa fa-laptop"></i>&nbsp;Basiques</a></li>
							  <li class=""><a href="<?php echo(base_url()) ?>admin/basic_image"><i class="fa fa-camera"></i>&nbsp; Ma Photo</a></li>
							  <li class=""><a href="<?php echo(base_url()) ?>admin/basic_secure"><i class="fa fa-lock"></i>&nbsp;  Ma Securité</a></li>
