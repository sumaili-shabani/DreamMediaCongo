...
if (isset($date1) && isset($date2)) {
	...
	$url= base_url().'admin/impressionStockEntrant_Date/'.$date1.'/'.$date2;
	# code...
	$detail3 = $this->db->query("SELECT COUNT(product_id) AS nombre, nom FROM profile_entree_stock  WHERE created_at BETWEEN '".$date1."'  AND '".$date2."' GROUP BY idcat ");
	if ($detail3->num_rows() > 0) {
	          foreach ($detail3->result_array() as $key) {

	          	$sexe = "Catégorie du produit :".$key["nom"];
	...
	$url= base_url().'admin/impressionStockEntrant';
	$detail3 = $this->db->query("SELECT COUNT(product_id) AS nombre, nom FROM profile_entree_stock GROUP BY idcat");
	if ($detail3->num_rows() > 0) {
	          foreach ($detail3->result_array() as $key) {
    ...
    <div class="card border-left-secondary shadow h-100 py-2">
        <div class="card-body">
            <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                    <div class="col-md-12">
                    	<form method="post" action="<?php echo(base_url()) ?>admin/stat_entree" class="row">
		...
		<div class="col-md-6 mb-2">
			<div class="card">
				<div class="card-header bg-secondary text-white text-center">
					Statistiques de produits entrant en stock 
				</div>
				<div class="card-body">
