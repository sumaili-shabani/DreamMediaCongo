     ...
     $(document).ready(function(){  
      ...
      var  $message = '';
               ...
               if(etape1 != '' && etape2 !='' && idart !='')
                {
                  ...
                  if (action =="Add") {
                      ...
                      $.ajax({  
                           url:"<?php echo base_url() . 'admin/operation_commentaire'?>",  
                           method:'POST',  
                  ...
                  if (action == 'Edit') {
                        ...
                        $.ajax({  
                             url:"<?php echo base_url() . 'admin/modification_commentaire'?>",  
                             method:'POST',  
                             data:new FormData(this),  
                             contentType:false,  
                             processData:false,  
          ...
          $(document).on('click', '.update', function(){  
               ...
               $.ajax({  
                    url:"<?php echo base_url(); ?>admin/fetch_single_commentaire",  
                    method:"POST",  
          ...
          $(document).on('click', '.delete', function(){
              ...
              if(confirm("Are you sure you want to delete this?"))
              {
                  ...
                  $.ajax({
                        url:"<?php echo base_url(); ?>admin/supression_commentaire",
                        method:"POST",
                        data:{idcomment:idcomment},
                        success:function(data)
                        {
        ...
        const showSuccessMessage = function(message) {
          ...
          function filtrage(nombre){
            $.ajax({
             url:"<?php echo base_url(); ?>admin/pagination_view_commentaire/"+nombre,
             method:"GET",
          ...
          {
            $.ajax({
             url:"<?php echo base_url(); ?>admin/pagination_view_commentaire",
             method:"GET",
         ...
         {
            $.ajax({
             url:"<?php echo base_url(); ?>admin/fetch_search_view_commentaire",
             method:"POST",
             data:{query:query},
              beforeSend:function()
              {
