            ...
            foreach ($Notifications->result_array() as $not) {
	              ...
	              <div class="media text-muted pt-3">
			        ...
			        <div class="pull-right">
	                    ...
	                    <a onclick="return confirm('Etes-vous sûre de vouloire Supprimer ce cours dans la liste favorie?')" href="<?php echo(base_url()) ?>entreprise/view_1/display_delete/<?php echo($not['id']) ?>" class="btn btn-default btn-sm"><i class="fa fa-trash"></i> supprimer</a> 
		           </div>
			    </div>
