                   ...
                   <div class="col-md-12 card">
                       <div class="row card-body">
                           ...
                           <div class="col-md-12">
	                         ...
	                         <form class="form-group col-md-12" method="post" action="<?php echo base_url(); ?>entreprise/download_photo_galery" style="margin-top: 10px;">
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $('#files').change(function(){
			  ...
			  {
			   $.ajax({
			    url:"<?php echo base_url(); ?>entreprise/upload_galery2", 
			    method:"POST",
			    data:form_data,
			    contentType:false,
			    cache:false,
	 ...
	 {
	  $.ajax({
	   url:"<?php echo base_url(); ?>entreprise/pagination_galery_member2/"+page,
	   method:"GET",
	   dataType:"json",
	    beforeSend:function()
	    {
           ...
           var idg = $(this).attr('idg');
			  ...
			  if(confirm("Etes-vous sûre de vouloir le supprimer?"))
	          {
		          ...
		          if(idg !='')
	              {
	                 // alert("idg:"+idg);
					  $.ajax({
			              url:"<?php echo base_url(); ?>entreprise/supression_photo_galery_personnele",
			              method:"POST",
			              data:{idg:idg},
			              success:function(data)
			              {
	 ...
	 $(document).on('submit', '#user_form', function(event){  
           ...
           if(nom != '')
            {
              ...
              if (action == 'Edit') {
                    ...
                    $.ajax({  
                         url:"<?php echo base_url() . 'entreprise/modification_galery_entrep_personnele'?>",  
                         method:'POST',  
	  ...
	  $(document).on('click', '.update', function(){  
           var idg = $(this).attr("idg");  
           $.ajax({  
                url:"<?php echo base_url(); ?>entreprise/fetch_single_galery_entrep_personnele",  
                method:"POST",  
                data:{idg:idg},  
                dataType:"json",  
                success:function(data)  
