(function() {
    ...
    */
    ...
    q("Promise", function(a) {
        ...
        b.prototype.then = function(g, h) {
            function k(A, G) {
                return "function" == typeof A ? function(ua) {
                    try {
                        l(A(ua))
                    } catch (va) {
                        p(va)
        ...
        b.race = function(g) {
            return new b(function(h, k) {
                for (var l = n(g), p = l.next(); !p.done; p = l.next()) d(p.value).G(h, k)
            })
        };
        b.all = function(g) {
            var h = n(g),
            ...
            return k.done ? d([]) : new b(function(l, p) {
                ...
                var A = [],
                    G = 0;
                do A.push(void 0), G++, d(k.value).G(x(A.length - 1), p), k = h.next(); while (!k.done)
            })
        };
        return b
    });
    ...
    q("Map", function(a) {
        ...
        e.prototype.set = function(h, k) {
            ...
            l.l ? l.l.value = k : (l.l = {
                ...
                key: h,
                value: k
            }, l.list.push(l.l), this.a.s.next = l.l, this.a.s = l.l, this.size++);
            return this
        };
    ...
    function z(a, b, c) {
        Function.prototype.bind && -1 != Function.prototype.bind.toString().indexOf("native code") ? z = Aa : z = Ba;
    ...
    function Fa(a) {
        return a instanceof E && a.constructor === E && a.b === Ea ? a.a : "type_error:Const"
    }
    function F(a) {
        return new E(Da, a)
    }
    ...
    H.f.I = {
        ha: {
            "gstatic.com": {
                loader: F("https://www.gstatic.com/charts/%{version}/loader.js"),
                debug: F("https://www.gstatic.com/charts/debug/%{version}/js/jsapi_debug_%{package}_module.js"),
                debug_i18n: F("https://www.gstatic.com/charts/debug/%{version}/i18n/jsapi_debug_i18n_%{package}_module__%{language}.js"),
                compiled: F("https://www.gstatic.com/charts/%{version}/js/jsapi_compiled_%{package}_module.js"),
                compiled_i18n: F("https://www.gstatic.com/charts/%{version}/i18n/jsapi_compiled_i18n_%{package}_module__%{language}.js"),
                css: F("https://www.gstatic.com/charts/%{version}/css/%{subdir}/%{filename}"),
                css2: F("https://www.gstatic.com/charts/%{version}/css/%{subdir1}/%{subdir2}/%{filename}"),
                third_party: F("https://www.gstatic.com/charts/%{version}/third_party/%{subdir}/%{filename}"),
                third_party2: F("https://www.gstatic.com/charts/%{version}/third_party/%{subdir1}/%{subdir2}/%{filename}"),
                third_party_gen: F("https://www.gstatic.com/charts/%{version}/third_party/%{subdir}/%{filename}")
            },
            "gstatic.cn": {
                loader: F("https://www.gstatic.cn/charts/%{version}/loader.js"),
                debug: F("https://www.gstatic.cn/charts/debug/%{version}/js/jsapi_debug_%{package}_module.js"),
                debug_i18n: F("https://www.gstatic.cn/charts/debug/%{version}/i18n/jsapi_debug_i18n_%{package}_module__%{language}.js"),
                compiled: F("https://www.gstatic.cn/charts/%{version}/js/jsapi_compiled_%{package}_module.js"),
                compiled_i18n: F("https://www.gstatic.cn/charts/%{version}/i18n/jsapi_compiled_i18n_%{package}_module__%{language}.js"),
                css: F("https://www.gstatic.cn/charts/%{version}/css/%{subdir}/%{filename}"),
                css2: F("https://www.gstatic.cn/charts/%{version}/css/%{subdir1}/%{subdir2}/%{filename}"),
                third_party: F("https://www.gstatic.cn/charts/%{version}/third_party/%{subdir}/%{filename}"),
                third_party2: F("https://www.gstatic.cn/charts/%{version}/third_party/%{subdir1}/%{subdir2}/%{filename}"),
                third_party_gen: F("https://www.gstatic.cn/charts/%{version}/third_party/%{subdir}/%{filename}")
            }
        },
        Y: ["default"],
        na: {
    ...
    function Pa(a) {
        return a instanceof I && a.constructor === I && a.b === Oa ? a.a : "type_error:TrustedResourceUrl"
    }
    function Qa(a, b) {
        var c = Fa(a);
        ...
        a = c.replace(Sa, function(d, e) {
            ...
            d = b[e];
            return d instanceof E ? Fa(d) : encodeURIComponent(String(d))
        });
        return Ta(a)
    }
    var Sa = /%{(\w+)}/g,
    ...
    function db(a, b) {
        a.src = Pa(b);
        (b = a.ownerDocument && a.ownerDocument.defaultView) && b != u ? b = xa(b.document) : (null === wa && (wa = xa(u.document)), b = wa);
    ...
    var gb = K("Opera"),
        hb = K("Trident") || K("MSIE"),
        ib = K("Edge"),
        jb = K("Gecko") && !(-1 != J.toLowerCase().indexOf("webkit") && !K("Edge")) && !(K("Trident") || K("MSIE")) && !K("Edge"),
        kb = -1 != J.toLowerCase().indexOf("webkit") && !K("Edge"),
        lb;
    a: {
        var mb = "",
            nb = function() {
    ...
    function Hb() {
        if (u.Promise && u.Promise.resolve) {
            ...
            var b = Jb;
            !y(u.setImmediate) || u.Window && u.Window.prototype && !K("Edge") && u.Window.prototype.setImmediate == u.setImmediate ? (yb || (yb = zb()), yb(b)) : u.setImmediate(b)
        }
    }
    var Ib = !1,
        Eb = new Ab;
    ...
    L.prototype.then = function(a, b, c) {
        return Ob(this, y(a) ? a : null, y(b) ? b : null, c)
    };
    ...
    function Ob(a, b, c, d) {
        ...
        e.a = new L(function(f, g) {
            ...
            e.b = c ? function(h) {
                try {
                    var k = c.call(d, h);
                    void 0 === k && h instanceof N ? g(h) : f(k)
                } catch (l) {
                    g(l)
                }
            } : g
    ...
    function M(a, b, c) {
        if (0 == a.a) {
            ...
            g || (a.j = c, a.a = b, a.c = null, Tb(a), 3 != b || c instanceof N || Vb(a, c))
        }
    }
    ...
    */
    ...
    O.prototype.cancel = function(a) {
        if (this.a) this.c instanceof O && this.c.cancel();
        else {
            if (this.b) {
                var b = this.b;
                delete this.b;
            ...
            this.a || (a = new P(this), Q(this), R(this, !1, a))
        }
    };
    ...
    function Yb(a) {
        if (a.i && a.a && ac(a)) {
            var b = a.i,
                c = bc[b];
            c && (u.clearTimeout(c.a), delete bc[b]);
            a.i = 0
        }
        ...
        for (var d = c = !1; a.h.length && !a.j;) {
            ...
            if (f = a.g ? g : f) try {
                ...
                if (Kb(b) || "function" === typeof u.Promise && b instanceof u.Promise) d = !0, a.j = !0
            } catch (k) {
                b = k, a.g = !0, ac(a) || (c = !0)
            }
        }
        a.c = b;
        d && (h = z(a.B, a, !0), d = z(a.B, a, !1), b instanceof O ? ($b(b, h, d), b.U = !0) : b.then(h, d));
        c && (b =
    ...
    function gc(a, b) {
        function c() {
            var e = a.shift();
            e = hc(e, b);
            a.length && $b(e, c, c, void 0);
            return e
        }
        if (!a.length) return dc();
        var d = fc.length;
        La(fc, a);
        if (d) return ec;
        a = fc;
    ...
    function hc(a, b) {
        ...
        0 < k && (h = window.setTimeout(function() {
            jc(e, !0);
            var l = new kc(1, "Timeout reached for loading script " + d);
            Q(g);
            R(g, !1, l)
        }, k), f.S = h);
        e.onload = e.onreadystatechange = function() {
            e.readyState && "loaded" != e.readyState && "complete" != e.readyState || (jc(e, c.la || !1, h), Q(g), R(g, !0, null))
        };
        e.onerror = function() {
            jc(e, !0, h);
            var l = new kc(0, "Error while loading script " +
                d);
            Q(g);
            R(g, !1, l)
        };
    ...
    function ic() {
        if (this && this.P) {
            var a = this.P;
            a && "SCRIPT" == a.tagName && jc(a, !0, this.S)
        }
    }
    function jc(a, b, c) {
    ...
    H.f.o.ua = function(a) {
        ...
        return Promise.all(Ha(c, function(d) {
            return new Promise(function(e) {
                return $b(d, e, null, void 0)
            })
        }))
    };
    H.f.o.wa = function(a, b, c) {
        return {
            format: a,
            K: b,
            ea: c
    ...
    function uc(a) {
        ...
        this.i = !1;
        var b;
        a instanceof uc ? (this.i = a.i, vc(this, a.g), this.j = a.j, this.a = a.a, wc(this, a.m), this.b = a.b, xc(this, yc(a.c)), this.h = a.h) : a && (b = String(a).match(sc)) ? (this.i = !1, vc(this, b[1] || "", !0), this.j = zc(b[2] || ""), this.a = zc(b[3] || "", !0), wc(this, b[4]), this.b = zc(b[5] || "", !0), xc(this, b[6] || "", !0), this.h = zc(b[7] || "")) : (this.i = !1, this.c = new U(null, this.i))
    }
    uc.prototype.toString = function() {
        ...
        b && a.push(Ac(b, Bc, !0), ":");
        var c = this.a;
        if (c || "file" == b) a.push("//"), (b = this.j) && a.push(Ac(b, Bc, !0), "@"), a.push(encodeURIComponent(String(c)).replace(/%25([0-9a-fA-F]{2})/g, "%$1")), c = this.m, null != c && a.push(":", String(c));
        if (c = this.b) this.a && "/" != c.charAt(0) && a.push("/"), a.push(Ac(c, "/" == c.charAt(0) ? Cc : Dc, !0));
        (c = this.c.toString()) && a.push("?", c);
        (c = this.h) && a.push("#", Ac(c, Ec));
        return a.join("")
    };
    ...
    function xc(a, b, c) {
        b instanceof U ? (a.c = b, Fc(a.c, a.i)) : (c || (b = Ac(b, Gc)), a.c = new U(b, a.i))
    }
    function zc(a, b) {
    ...
    function V(a) {
        a.a || (a.a = new qc, a.b = 0, a.c && tc(a.c, function(b, c) {
    ...
    function Ic(a, b) {
        V(a);
        b = W(a, b);
        T(a.a.b, b) && (a.c = null, a.b -= a.a.get(b).length, a = a.a, T(a.b, b) && (delete a.b[b], a.c--, a.a.length > 2 * a.c && rc(a)))
    }
    function Jc(a, b) {
        V(a);
        b = W(a, b);
    ...
    m.D = function(a) {
        V(this);
        var b = [];
        if ("string" === typeof a) Jc(this, a) && (b = Ja(b, this.a.get(W(this, a))));
        else {
            a = this.a.D();
    ...
    m.set = function(a, b) {
        ...
        this.c = null;
        a = W(this, a);
        Jc(this, a) && (this.b -= this.a.get(a).length);
        this.a.set(a, [b]);
        this.b += 1;
        return this
    };
    ...
    function Fc(a, b) {
        b && !a.g && (V(a), a.c = null, a.a.forEach(function(c, d) {
            var e = d.toLowerCase();
            d != e && (Ic(this, d), Ic(this, e), 0 < c.length && (this.c = null, this.a.set(W(this, e), Ka(c)), this.b += c.length))
        }, a));
        a.g = b
    };
    H.f.u = {};
    ...
    function Nc() {
        Y = X = "";
        Lc = Z = Kc = null;
        v("google.load") || (B("google.load", Oc), B("google.setOnLoadCallback", H.R));
        var a = document.getElementsByTagName("script");
        a = (document.currentScript || a[a.length - 1]).getAttribute("src");
        a = new uc(a);
        var b = a.a;
        Mc = b = b.match(/^www\.gstatic\.cn/) ? "gstatic.cn" : "gstatic.com";
        Pc(a)
    }
    function Pc(a) {
        a = new U(a.c.toString());
        var b = a.get("callback");
        "string" === typeof b && (b = Qc(b), H.f.v.aa().then(b));
        a = a.get("autoload");
    ...
    function Rc(a) {
        ...
        a = b;
        do {
            if (b === H.f.J[b]) throw Error("Infinite loop in version mapping: " + b);
            (c = H.f.J[b]) && (b = c)
        } while (c);
        c = (d ? "testing-" : "") + b;
        return {
    ...
    function Sc(a) {
        var b = H.f.I.ha[Mc].loader,
            c = Rc(a);
        return H.f.o.load(b, {
            version: c.ba
        }).then(function() {
            var d = v("google.charts.loader.VersionSpecific.load") || v("google.charts.loader.publicLoad") || v("google.charts.versionSpecific.load");
            if (!d) throw Error("Bad version: " + a);
            Lc = function(e) {
                e = d(c.version, e);
                if (null == e || null == e.then) {
                    var f = v("google.charts.loader.publicSetOnLoadCallback") || v("google.charts.versionSpecific.setOnLoadCallback");
    ...
    function Tc(a) {
        "string" === typeof a && (a = [a]);
        Array.isArray(a) && 0 !== a.length || (a = H.f.I.Y);
        var b = [];
    ...
    function Uc(a) {
        ...
        for (var b = a.replace(/-/g, "_").toLowerCase();
            "string" === typeof b;) a = b, b = H.f.W[b], b === a && (b = !1);
        b || (a.match(/_[^_]+$/) ? (a = a.replace(/_[^_]+$/, ""), a = Uc(a)) : a = "en");
        return a
    }
    function Vc(a) {
        a = a || "";
    ...
    function Yc(a, b) {
        ...
        b.packages = Tc(b.packages);
        return Z = Kc.then(function() {
            return Lc(b)
        })
    }
    H.ia = function(a) {
        return H.load(Object.assign({}, a, {
            safeMode: !0
        }))
    };
    B("google.charts.safeLoad", H.ia);
    H.load = function(a) {
    ...
    B("google.charts.load", H.load);
    H.R = function(a) {
        if (!Z) throw Error("Must call google.charts.load before google.charts.setOnLoadCallback");
        return a ? Z.then(a) : Z
    };
    B("google.charts.setOnLoadCallback", H.R);
    var Zc = F("https://maps.googleapis.com/maps/api/js?jsapiRedirect=true"),
        $c = F("https://maps-api-ssl.google.com/maps?jsapiRedirect=true&file=googleapi");
    function ad(a, b, c) {
        ...
        Z = new Promise(function(h) {
            var k = Qc(c && c.callback);
            H.f.o.load(g, {}, f).then(k).then(h)
        })
    }
    var bd = F("https://www.gstatic.com/inputtools/js/ita/inputtools_3.js");
    function cd(a, b, c) {
        za(c) && c.packages ? (Array.isArray(c.packages) ? c.packages : [c.packages]).includes("inputtools") ? (console.warn('Loading "elements" with the jsapi loader is deprecated.\nPlease load ' + (bd + " directly.")), Z = new Promise(function(d) {
            var e = Qc(c && c.callback);
            H.f.o.load(bd, {}, {}).then(e).then(d)
    ...
    var dd = F("https://ajax.googleapis.com/ajax/libs/%{module}/%{version}/%{file}");
    function ed(a, b) {
        var c;
        do {
    ...
    function fd(a, b, c) {
        ...
        if (d) {
            ...
            Z = new Promise(function(f) {
                var g = Qc(c && c.callback);
                H.f.o.load(dd, e).then(g).then(f)
            })
    ...
    B("google.loader.LoadFailure", !1);
    Mc ? console.warn("Google Charts loader.js should only be loaded once.") : Nc();
    H.f.u.ra = Nc;
    H.f.u.xa = Rc;
    H.f.u.ya = Uc;
    H.f.u.za = Tc;
