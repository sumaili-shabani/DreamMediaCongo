...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 18 juin 2021 à 17:24
...
(23, 64, '169.159.215.21', '2021-06-11 14:02:41'),
...
--
ALTER TABLE `article`
  MODIFY `idart` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=75;
...
--
ALTER TABLE `vues`
  MODIFY `idv` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
